...
public final class Constants {
  public static final class DriveConstants {
    ...
    public static final double kMaxSpeedMetersPerSecond = 3 ; //Lowered
    public static final double kMaxAngularSpeed = 1 * Math.PI; // radians per second

    // Chassis configuration
    public static final double kTrackWidth = Units.inchesToMeters(27.5); // CHANGE THIS 
    // Distance between centers of right and left wheels on robot
    public static final double kWheelBase = Units.inchesToMeters(27.5); // CCHANGE THIS 
  ...
  public static final class IntakeConstants {
    ...
    public static final double armGearRatio = 1 / 45;
