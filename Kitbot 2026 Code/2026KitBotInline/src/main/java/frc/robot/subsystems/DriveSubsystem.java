...
public class DriveSubsystem extends SubsystemBase {
  ...
  // The gyro sensor
  private final Pigeon2 m_gyro = new Pigeon2(9); // CHANGE THIS 
  

  // Odometry class for tracking robot pose
  SwerveDriveOdometry m_odometry = new SwerveDriveOdometry(
      DriveConstants.kDriveKinematics,
      Rotation2d.fromDegrees(m_gyro.getRotation2d().getDegrees()), // I HAVE NOT CLUE IF THIS IS RIGHT OR WILL WORK
  ...
  public double getTurnRate() {
    return m_gyro.getRotation2d().getDegrees() * (DriveConstants.kGyroReversed ? -1.0 : 1.0);
  }
}
